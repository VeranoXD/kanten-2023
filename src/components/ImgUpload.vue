<template>
  <div>
    ...
    <input
      type="text"
      placeholder="Title"
      v-model="addItemData.AddItemDataTitle"
    />
    <input
      type="text"
      placeholder="Description"
      v-model="addItemData.AddItemDataDescription"
    />
    ...
    <br />
    <button
      @click.prevent="firebaseAddSingleItem()"
      :disabled="addItemData.uploadBtnDisabled"
    >
      Add item
    </button>
